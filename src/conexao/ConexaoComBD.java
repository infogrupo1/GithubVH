...
public class ConexaoComBD {
    ...
    public static Connection conexao(){
        ...
        String url = "jdbc:mysql://localhost:3306/trabDoBruno?useTimezone=true&serverTimezone=UTC";        
        ...
        try {            
            ...
            Logger.getLogger(ConexaoComBD.class.getName()).log(Level.SEVERE, null, ex);
        }
        return null;       
    }
